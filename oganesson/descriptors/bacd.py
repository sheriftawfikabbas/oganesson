...
class BACD(Descriptors):
    ...
    def describe(self):
        ...
        numElements = len(self.structure().atomic_numbers)
        ...
        spg = self.structure().get_space_group_info()
        ...
        atomic_numbers = [np.mean(self.structure().atomic_numbers), np.max(self.structure().atomic_numbers), np.min(
            self.structure().atomic_numbers), np.std(self.structure().atomic_numbers)]

        distance_matrix += [np.mean(self.structure().distance_matrix), np.max(self.structure().distance_matrix),
                            np.min(self.structure().distance_matrix), np.std(self.structure().distance_matrix)]
